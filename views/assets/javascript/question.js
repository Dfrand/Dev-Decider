...
//questions and answers should have images appear in four
var questions = [{
...
$(document).on("click", ".button", function(e) {
    ...
    //take out wins and losses counter
var game = {
    questions: questions,
    currentQuestion: 0,
    counter: 10,
    ...
    //if time is up, question will show up again
    //error message: "hurry up! Your dev is waiting!"
    timeUp: function() {
        $(".button").remove();
        clearInterval(timer);
        game.unansweredCounter++;
        $("#question").text("Hurry Up! Your dev is waiting! ;) " + questions[game.currentQuestion].answer + ".");
    ...
    //createButtons function should also show pictures...
    ...
    //take out since it is not a game
    //user should just be able to answer questions and move to next question
    ...
    //keep this function 
    //take out gifs code, replace with pictures for each answer
    ...
    //us this function for displaying team member's info
    endGame: function() {
            $(".gifs").remove();
            clearInterval(timer);
        ...
        //change function to reset for every page?
    reset: function() {
        $("#question").empty();
        $(".button").remove();
        $(".gifs").remove();
